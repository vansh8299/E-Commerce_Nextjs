  ...
  return (
   ...
   <div className="container px-5 py-16 mx-auto">
     <div className="lg:w-4/5 mx-auto flex flex-wrap">
       <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51byp5tQ86L._AC_UL320_.jpg"/>
       <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
         ...
         <div className="flex">
           <span className="title-font font-medium text-2xl text-gray-900">₹1599.00</span>
           <button className="flex ml-8 text-white text-sm bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Buy Now</button>
           <button onClick={()=>{addToCart(slug, 1, 1599, 'Wear the Trend(XL, Red)', 'XL', "Red")}} className="flex ml-4 text-white text-sm bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Add To Cart</button>
         ...
         <div className="pin mt-6 flex space-x-2 text-sm">
          ...
          <button onClick={checkService} className='text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded'>Check Availability</button>
         </div>
