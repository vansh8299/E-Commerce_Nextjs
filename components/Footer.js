  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        <Link href={"/"} className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          <Image src="/logo.jpg" width={100} height={200}/>
          <span className="ml-3 text-xl">TrendyClothes.com</span>
        </Link>
        
        <p className="mt-2 text-sm text-gray-500 px-4">Wear the &lt;Trend/&gt;</p>
        <p className='text-sm text-gray-500 px-4'>Premium Tshirts, Hoodies, Mugs and Stickers availbable here.</p>
    ...
    <div className="bg-gray-100">
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 TrendyClothes — All Rights Reserved
